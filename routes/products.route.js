...
const { postProduct, patchProduct, getProducts, getProductsByCategory, getProductByCategoryAndId, searchProducts, getProductsProgress } = require('../controllers/products');
